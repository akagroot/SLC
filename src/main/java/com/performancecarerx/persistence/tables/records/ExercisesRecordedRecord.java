...
public class ExercisesRecordedRecord extends UpdatableRecordImpl<ExercisesRecordedRecord> implements Record8<Integer, Integer, Timestamp, Integer, Integer, Integer, Timestamp, String> {
     ...
     */
    @Override
    public Row8<Integer, Integer, Timestamp, Integer, Integer, Integer, Timestamp, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Timestamp, Integer, Integer, Integer, Timestamp, String> valuesRow() {
     ...
     */
    @Override
    public ExercisesRecordedRecord value1(Integer value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public ExercisesRecordedRecord values(Integer value1, Integer value2, Timestamp value3, Integer value4, Integer value5, Integer value6, Timestamp value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExercisesRecordedRecord(Integer id, Integer exerciseId, Timestamp recordedDttm, Integer weight, Integer reps, Integer userId, Timestamp createdDttm, String note) {
        super(ExercisesRecorded.EXERCISES_RECORDED);
